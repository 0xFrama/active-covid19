...
class COVID19Dataset_2(Dataset):
    ...
    def get_video_dataset(self, video_hash, transforms):
        ...
        return TransformableFullMetadataSubset_2(self, indices, transforms)
...
class TransformableFullMetadataSubset_2(Subset):

    def __init__(self, dataset, indices, transforms=None):
        super(TransformableFullMetadataSubset_2, self).__init__(dataset, indices)
        self.transforms = transforms
    ...
    def __getitem__(self, idx):
        ...
        return frame, {"multiclass_label": multiclass_label,
                       ...
                       "filename": self.dataset.metadata.filename[translated_idx],
...
def covid_train_test_split_2(args, covid19_dataset, train_transforms, test_transforms):
    # split patients
    ...
    # subset the dataset
    train_subset = TransformableFullMetadataSubset_2(covid19_dataset, train_indices, train_transforms) # train_indeces: frame per training
    test_subset = TransformableFullMetadataSubset_2(covid19_dataset, test_indices, test_transforms)
